...
| Method | Implementation(s) | Notes |
|--------|-------------------|-------|
| `method()` | `ConcreteImpl::method()` | Brief description |
...
| SOUP Component | Version | Interaction |
|---------------|---------|-------------|
| [dependency] | [version] | [how this interface uses it] |
